        ...
        try {
            ...
            if ($sth->rowCount() > 0) {
                ...
                while($row=$sth->fetch()) {
                    ...
                    echo    "<div onmouseover='this.style.cursor=pointer' class='salaDisplay d-flex align-items-center gallery_product border rounded bg-white me-3 mb-3' onclick='redirectSala($row->idSala)'>
                                <div class='d-inline'>
